...
REG DELETE "HKCR\Directory\Background\shell\WSL" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\Directory\shell\WSL" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\Drive\shell\WSL" /V "Extended" /F 1>NUL 2>&1
