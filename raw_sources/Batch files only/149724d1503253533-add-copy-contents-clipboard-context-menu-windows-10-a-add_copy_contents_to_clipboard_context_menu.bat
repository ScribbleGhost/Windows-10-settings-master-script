...
REM For BAT files
REG DELETE "HKCR\batfile\shell\CopyContents" /V "Extended" /F 1>NUL 2>&1
...
REM For CMD files
REG DELETE "HKCR\cmdfile\shell\CopyContents" /V "Extended" /F 1>NUL 2>&1
...
REM For HTML files
REG DELETE "HKCR\htmlfile\shell\CopyContents" /V "Extended" /F 1>NUL 2>&1
...
REM For JS files
REG DELETE "HKCR\JSFile\shell\CopyContents" /V "Extended" /F 1>NUL 2>&1
...
REM For REG files
REG DELETE "HKCR\regfile\shell\CopyContents" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\rtffile\shell\CopyContents" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\txtfile\shell\CopyContents" /V "Extended" /F 1>NUL 2>&1
...
REM For VBS files
REG DELETE "HKCR\VBSFile\shell\CopyContents" /V "Extended" /F 1>NUL 2>&1
