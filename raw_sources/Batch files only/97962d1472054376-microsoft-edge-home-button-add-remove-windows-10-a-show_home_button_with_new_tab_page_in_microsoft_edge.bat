...
REG ADD "HKCU\SOFTWARE\Classes\Local Settings\Software\Microsoft\Windows\CurrentVersion\AppContainer\Storage\microsoft.microsoftedge_8wekyb3d8bbwe\MicrosoftEdge\Main" /V "HomeButtonPage" /T "REG_SZ" /D "about:tabs" /F 1>NUL 2>&1
