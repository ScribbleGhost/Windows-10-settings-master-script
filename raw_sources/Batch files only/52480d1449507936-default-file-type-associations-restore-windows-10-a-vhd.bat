...
REG DELETE "HKEY_CLASSES_ROOT\.vhd" /F 1>NUL 2>&1
REG ADD "HKCR\.vhd" /V "" /D "Windows.VhdFile" /F 1>NUL 2>&1
REG DELETE "HKEY_CLASSES_ROOT\SystemFileAssociations\.vhd" /F 1>NUL 2>&1
...
REG DELETE "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.vhd" /F 1>NUL 2>&1
REG DELETE "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Roaming\OpenWith\FileExts\.vhd" /F 1>NUL 2>&1
