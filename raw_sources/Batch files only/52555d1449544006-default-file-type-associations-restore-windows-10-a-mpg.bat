...
REG DELETE "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.mpg" /F 1>NUL 2>&1
Call :Add_Special_Value "HKCU" "SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.mpg\OpenWithProgids" "WMP11.AssocFile.MPEG" "REG_NONE" ""
REG ADD "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.mpg\UserChoice" /V "Hash" /T "REG_SZ" /D "WSx2mXVperA=" /F 1>NUL 2>&1
REG ADD "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.mpg\UserChoice" /V "ProgId" /T "REG_SZ" /D "WMP11.AssocFile.mpg" /F 1>NUL 2>&1
REG DELETE "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Roaming\OpenWith\FileExts\.mpg" /F 1>NUL 2>&1
REG ADD "HKCU\SOFTWARE\Microsoft\Windows\Roaming\OpenWith\FileExts\.mpg\UserChoice" /V "Hash" /T "REG_SZ" /D "HvRVLWz6KuE=" /F 1>NUL 2>&1
REG ADD "HKCU\SOFTWARE\Microsoft\Windows\Roaming\OpenWith\FileExts\.mpg\UserChoice" /V "ProgId" /T "REG_SZ" /D "WMP11.AssocFile.mpg" /F 1>NUL 2>&1
