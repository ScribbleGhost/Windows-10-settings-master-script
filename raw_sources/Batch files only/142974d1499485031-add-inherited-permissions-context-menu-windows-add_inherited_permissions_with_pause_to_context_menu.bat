...
REG ADD "HKCR\*\shell\InheritedPermissions\shell\001flyout\command" /V "" /D "powershell -windowstyle hidden -command \"Start-Process cmd -ArgumentList '/c icacls \"%%1\" /inheritance:e ^& pause' -Verb runAs\"" /F 1>NUL 2>&1
...
REG ADD "HKCR\*\shell\InheritedPermissions\shell\002flyout\command" /V "" /D "powershell -windowstyle hidden -command \"Start-Process cmd -ArgumentList '/c icacls \"%%1\" /inheritance:d ^& pause' -Verb runAs\"" /F 1>NUL 2>&1
...
REG ADD "HKCR\*\shell\InheritedPermissions\shell\003flyout\command" /V "" /D "powershell -windowstyle hidden -command \"Start-Process cmd -ArgumentList '/c icacls \"%%1\" /inheritance:r ^& pause' -Verb runAs\"" /F 1>NUL 2>&1
...
REG ADD "HKCR\Directory\shell\InheritedPermissions\shell\001flyout\command" /V "" /D "powershell -windowstyle hidden -command \"Start-Process cmd -ArgumentList '/c icacls \"%%1\" /inheritance:e ^& pause' -Verb runAs\"" /F 1>NUL 2>&1
...
REG ADD "HKCR\Directory\shell\InheritedPermissions\shell\002flyout\command" /V "" /D "powershell -windowstyle hidden -command \"Start-Process cmd -ArgumentList '/c icacls \"%%1\" /inheritance:d ^& pause' -Verb runAs\"" /F 1>NUL 2>&1
...
REG ADD "HKCR\Directory\shell\InheritedPermissions\shell\003flyout\command" /V "" /D "powershell -windowstyle hidden -command \"Start-Process cmd -ArgumentList '/c icacls \"%%1\" /inheritance:r ^& pause' -Verb runAs\"" /F 1>NUL 2>&1
