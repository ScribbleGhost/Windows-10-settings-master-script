...
REG DELETE "HKCR\Directory\Background\shell\Bash" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\Directory\shell\Bash" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\Drive\shell\Bash" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\LibraryFolder\Background\shell\Bash" /V "Extended" /F 1>NUL 2>&1
