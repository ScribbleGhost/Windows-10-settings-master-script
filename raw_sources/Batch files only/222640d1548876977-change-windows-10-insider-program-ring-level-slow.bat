...
REG ADD "HKLM\SOFTWARE\Microsoft\WindowsSelfHost\UI\Selection" /V "UIRing" /T "REG_SZ" /D "WIS" /F 1>NUL 2>&1
...
REG ADD "HKLM\SOFTWARE\Microsoft\WindowsSelfHost\Applicability" /V "Ring" /T "REG_SZ" /D "WIS" /F 1>NUL 2>&1
