...
REG ADD "HKCR\Directory\shell\OpenCmdHereAsAdmin" /V "Extended" /T "REG_SZ" /D "" /F 1>NUL 2>&1
...
REG ADD "HKCR\Directory\Background\shell\OpenCmdHereAsAdmin" /V "Extended" /T "REG_SZ" /D "" /F 1>NUL 2>&1
...
REG ADD "HKCR\Drive\shell\OpenCmdHereAsAdmin" /V "Extended" /T "REG_SZ" /D "" /F 1>NUL 2>&1
...
REG ADD "HKCR\LibraryFolder\background\shell\OpenCmdHereAsAdmin" /V "Extended" /T "REG_SZ" /D "" /F 1>NUL 2>&1
