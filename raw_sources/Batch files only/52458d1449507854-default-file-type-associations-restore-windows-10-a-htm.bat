...
REG DELETE "HKEY_CLASSES_ROOT\.htm" /F 1>NUL 2>&1
REG ADD "HKCR\.htm" /V "" /D "htmlfile" /F 1>NUL 2>&1
REG ADD "HKCR\.htm" /V "Content Type" /T "REG_SZ" /D "text/html" /F 1>NUL 2>&1
REG ADD "HKCR\.htm" /V "PerceivedType" /T "REG_SZ" /D "text" /F 1>NUL 2>&1
REG ADD "HKCR\.htm\OpenWithList\notepad.exe" /V "" /D "" /F 1>NUL 2>&1
Call :Add_Special_Value "HKCR" ".htm\OpenWithProgids" "AppX4hxtad77fbk3jkkeerkrm0ze94wjf3s9" "REG_NONE" ""
REG ADD "HKCR\.htm\OpenWithProgids" /V "ChromeHTML" /T "REG_SZ" /D "" /F 1>NUL 2>&1
REG ADD "HKCR\.htm\OpenWithProgids" /V "IE.AssocFile.HTM" /T "REG_SZ" /D "" /F 1>NUL 2>&1
Call :Add_Special_Value "HKCR" ".htm\OpenWithProgids" "OperaStable" "REG_NONE" ""
REG ADD "HKCR\.htm\PersistentHandler" /V "" /D "{eec97550-47a9-11cf-b952-00aa0051fe20}" /F 1>NUL 2>&1
...
REG DELETE "HKEY_CLASSES_ROOT\SystemFileAssociations\.htm" /F 1>NUL 2>&1
REG ADD "HKCR\SystemFileAssociations\.htm" /V "PerceivedType" /T "REG_SZ" /D "document" /F 1>NUL 2>&1
REG ADD "HKCR\SystemFileAssociations\.htm\ShellEx\{8895b1c6-b41f-4c1c-a562-0d564250836f}" /V "" /D "{f8b8412b-dea3-4130-b36c-5e8be73106ac}\"" /F 1>NUL 2>&1
REG DELETE "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.htm" /F 1>NUL 2>&1
Call :Add_Special_Value "HKCU" "SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.htm\OpenWithProgids" "htmlfile" "REG_NONE" ""
REG ADD "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.htm\UserChoice" /V "Hash" /T "REG_SZ" /D "/dEIpgCvIHY=" /F 1>NUL 2>&1
REG ADD "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.htm\UserChoice" /V "ProgId" /T "REG_SZ" /D "AppX4hxtad77fbk3jkkeerkrm0ze94wjf3s9" /F 1>NUL 2>&1
REG DELETE "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Roaming\OpenWith\FileExts\.htm" /F 1>NUL 2>&1
REG ADD "HKCU\SOFTWARE\Microsoft\Windows\Roaming\OpenWith\FileExts\.htm\UserChoice" /V "Hash" /T "REG_SZ" /D "+f6J68DY5zQ=" /F 1>NUL 2>&1
REG ADD "HKCU\SOFTWARE\Microsoft\Windows\Roaming\OpenWith\FileExts\.htm\UserChoice" /V "ProgId" /T "REG_SZ" /D "IE.AssocFile.HTM" /F 1>NUL 2>&1
