...
REG DELETE "HKCR\Directory\Background\shell\Powershell" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\Directory\shell\Powershell" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\Drive\shell\Powershell" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\LibraryFolder\Background\shell\PowerShell" /V "Extended" /F 1>NUL 2>&1
