...
REG ADD "HKCU\Software\Policies\Microsoft\Windows\Control Panel\Desktop" /V "EnablePerProcessSystemDPI" /T "REG_DWORD" /D "0x00000001" /F 1>NUL 2>&1
...
REG ADD "HKLM\SOFTWARE\Policies\Microsoft\Windows\Control Panel\Desktop" /V "EnablePerProcessSystemDPI" /T "REG_DWORD" /D "0x00000001" /F 1>NUL 2>&1
