...
REG ADD "HKCR\Directory\shell\cmd2" /V "Extended" /T "REG_SZ" /D "" /F 1>NUL 2>&1
...
REG ADD "HKCR\Directory\Background\shell\cmd2" /V "Extended" /T "REG_SZ" /D "" /F 1>NUL 2>&1
...
REG ADD "HKCR\Drive\shell\cmd2" /V "Extended" /T "REG_SZ" /D "" /F 1>NUL 2>&1
...
REG ADD "HKCR\LibraryFolder\Background\shell\cmd2" /V "Extended" /T "REG_SZ" /D "" /F 1>NUL 2>&1
