...
REG DELETE "HKCR\AppX43hnxtbyyps62jhe9sqpdzxn1790zetc\Shell\ShellCreateVideo" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\AppXk0g4vb8gvt7b93tg50ybcy892pge6jmt\Shell\ShellCreateVideo" /V "Extended" /F 1>NUL 2>&1
