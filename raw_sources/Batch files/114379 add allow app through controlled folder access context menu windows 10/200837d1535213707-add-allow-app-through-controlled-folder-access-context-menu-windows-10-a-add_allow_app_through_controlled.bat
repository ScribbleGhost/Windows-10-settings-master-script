...
REG DELETE "HKCR\comfile\Shell\AllowControlledFolderAccess" /V "Extended" /F 1>NUL 2>&1
...
REG DELETE "HKCR\exefile\Shell\AllowControlledFolderAccess" /V "Extended" /F 1>NUL 2>&1
