...
REG ADD "HKCR\*\shell\ResetPermissions\command" /V "" /D "powershell -windowstyle hidden -command \"Start-Process cmd -ArgumentList '/c icacls \"%%1\" /reset' -Verb runAs\"" /F 1>NUL 2>&1
...
REG ADD "HKCR\Directory\shell\ResetPermissions\shell\001flyout\command" /V "" /D "powershell -windowstyle hidden -command \"Start-Process cmd -ArgumentList '/c icacls \"%%1\" /reset' -Verb runAs\"" /F 1>NUL 2>&1
...
REG ADD "HKCR\Directory\shell\ResetPermissions\shell\002flyout\command" /V "" /D "powershell -windowstyle hidden -command \"Start-Process cmd -ArgumentList '/c icacls \"%%1\" /reset /t /c /l' -Verb runAs\"" /F 1>NUL 2>&1
